#ifdef CCOSEXTWIN_EXPORTS
#define CCOSEXTWIN_API extern "C" __declspec(dllexport)
#else
#define CCOSEXTWIN_API extern "C" __declspec(dllimport)
#endif
...
CCOSEXTWIN_API int ccos_ext_load(clib::cext*);
CCOSEXTWIN_API int ccos_ext_unload(clib::cext*);
