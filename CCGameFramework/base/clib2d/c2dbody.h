...
namespace clib {
    ...
    public:
        ...
        virtual v2 _min() const = 0; // 下边界
        virtual v2 _max() const = 0; // 上边界
        ...
        virtual void draw(CComPtr<ID2D1RenderTarget>& rt, const CRect& bounds, const clib::BrushBag& brushes) = 0; // 绘制
