...
// Author: bajdcc
//
#ifndef CLIBJSON_LEXER_H
#define CLIBJSON_LEXER_H
...
namespace clib {
    ...
    class clexer_json {
    public:
        explicit clexer_json(string_t str);
        ~clexer_json();

        clexer_json(const clexer_json&) = delete;
        clexer_json& operator=(const clexer_json&) = delete;
