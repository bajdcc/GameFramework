...
namespace clib {
    ...
    class csemantic {
    public:
        virtual js_backtrace_direction check(js_pda_edge_t, js_ast_node*) = 0;
    ...
    public:
        ...
        using terminal_cb = void (*)(const cjslexer*, int idx,
            std::vector<std::shared_ptr<js_backtrace_t>>& bks, std::shared_ptr<js_backtrace_t>& bk);
    ...
    private:
        ...
        bool valid_trans(js_backtrace_t& bk, js_pda_trans& trans, js_unit_token** = nullptr);
        void do_trans(js_backtrace_t& bk, const js_pda_trans& trans);
        bool LA(js_backtrace_t& bk, js_unit* u, js_pda_trans& trans, js_unit_token** = nullptr);
        ;
        ...
        void print_bk(std::vector<std::shared_ptr<js_backtrace_t>>& bks) const;
        void copy_bk(js_backtrace_t& dst, js_backtrace_t& src);
        void del_bk(js_backtrace_t&);
